    ...
    if (isFuncAllowed('autoreport::ipfilter')) {
        ...
        if (!$_GET['action']) {
            ...
            while ($obj = mysql_fetch_object($res)) {
                ...
                echo "<tr><td  class=$c>".  $obj->description."&nbsp; &nbsp;</td><td  class=$c>".$obj->hash."&nbsp; &nbsp;</td><td>".htmlURLbutton ('Remove', 'autoreport', 'action=remove&id='.$obj->id)."</td><td> ".htmlURLbutton ('Edit', 'autoreport', 'action=edit&id='.$obj->id)."</td></tr>";
            }
