<?php // $Id: entermatch.php,v 1.9 2006/09/02 21:44:08 dennismp Exp $ vim:sts=2:et 
    ...
    if($teama == $teamb) {
      ...
      if ($mid)
        section_entermatch_editIt ($mid,$teama,$teamb,$scorea,$scoreb, $tsActUnix, $del, $mlen);
          ...
          section_entermatch_postIt ($teamA,$teamB,$scoreA,$scoreB, $tsActUnix,$mlen,$s_playerid);
...
function section_entermatch_postIt ($teamA,$teamB,$scoreA,$scoreB, $tsActUnix,$mlen,$s_playerid){
  snCheck('entermatch');
  section_entermatch_orderResults (&$teamA, &$teamB, &$scoreA, &$scoreB);
